...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    closer = make_city("closer", lat, lon)
    closer_a = distance(closer, city_a)
    closer_b = distance(closer, city_b)
    return get_name(city_a) if closer_a < closer_b else get_name(city_b)
